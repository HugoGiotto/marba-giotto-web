  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-[var(--bg)]">
      <div className="relative">
        <video className="h-48 w-full object-cover md:h-full" autoPlay muted loop playsInline preload="metadata"
          poster="/images/login-poster.jpg" src="/videos/video-login.mp4" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-black/30 to-transparent md:bg-none" />
      </div>
